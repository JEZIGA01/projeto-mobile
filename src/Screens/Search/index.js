...
export default function Features() {
  return (
    <ImageBackground source={require('../Images/bgNGT.png')} style={{ flex: 1 }} resizeMode="cover">
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        <View style={styles.viewAlign}>
          <Text style={styles.txtH1}>Busca de Chamados</Text>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.card}>
              ...
              <View style={[styles.obsContainer, { width
: '100%' }]}>
